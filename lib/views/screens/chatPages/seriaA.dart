...
class SeriaAChatPage extends StatefulWidget {
  const SeriaAChatPage({
    super.key,
  });

  @override
  _SeriaAChatPageState createState() => _SeriaAChatPageState();
}

class _SeriaAChatPageState extends State<SeriaAChatPage> {
  late PubNub pubNub;
  late Subscription subscription;
  TextEditingController messageController = TextEditingController();
  List<ChatMessage> messages = [];
  String channelName = "SERIA A";

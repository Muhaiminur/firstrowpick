...
class NFLChatPage extends StatefulWidget {
  const NFLChatPage({
    super.key,
  });

  @override
  _NFLChatPageState createState() => _NFLChatPageState();
}

class _NFLChatPageState extends State<NFLChatPage> {
  late PubNub pubNub;
  late Subscription subscription;
  TextEditingController messageController = TextEditingController();
  List<ChatMessage> messages = [];
  String channelName = "NFL";

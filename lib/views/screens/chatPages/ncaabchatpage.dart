...
class NCAABChatPage extends StatefulWidget {
  const NCAABChatPage({
    super.key,
  });

  @override
  _NCAABChatPageState createState() => _NCAABChatPageState();
}

class _NCAABChatPageState extends State<NCAABChatPage> {
  late PubNub pubNub;
  late Subscription subscription;
  TextEditingController messageController = TextEditingController();
  List<ChatMessage> messages = [];
  String channelName = "NCAAB";

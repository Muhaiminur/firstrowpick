...
class NCAAFChatPage extends StatefulWidget {
  const NCAAFChatPage({
    super.key,
  });

  @override
  _NCAAFChatPageState createState() => _NCAAFChatPageState();
}

class _NCAAFChatPageState extends State<NCAAFChatPage> {
  late PubNub pubNub;
  late Subscription subscription;
  TextEditingController messageController = TextEditingController();
  List<ChatMessage> messages = [];
  String channelName = "NCAAF";

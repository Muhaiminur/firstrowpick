...
class MLBChatPage extends StatefulWidget {
  const MLBChatPage({
    super.key,
  });

  @override
  _MLBChatPageState createState() => _MLBChatPageState();
}

class _MLBChatPageState extends State<MLBChatPage> {
  late PubNub pubNub;
  late Subscription subscription;
  TextEditingController messageController = TextEditingController();
  List<ChatMessage> messages = [];
  String channelName = "MLB";

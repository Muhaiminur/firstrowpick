...
class NHLChatPage extends StatefulWidget {
  const NHLChatPage({
    super.key,
  });

  @override
  _NHLChatPageState createState() => _NHLChatPageState();
}

class _NHLChatPageState extends State<NHLChatPage> {
  late PubNub pubNub;
  late Subscription subscription;
  TextEditingController messageController = TextEditingController();
  List<ChatMessage> messages = [];
  String channelName = "NHL";

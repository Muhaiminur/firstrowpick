...
class WnbaChatPage extends StatefulWidget {
  const WnbaChatPage({
    super.key,
  });

  @override
  _WnbaChatPageState createState() => _WnbaChatPageState();
}

class _WnbaChatPageState extends State<WnbaChatPage> {
  late PubNub pubNub;
  late Subscription subscription;
  TextEditingController messageController = TextEditingController();
  List<ChatMessage> messages = [];
  String channelName = "WNBA";

...
class MLSChatPage extends StatefulWidget {
  const MLSChatPage({
    super.key,
  });

  @override
  _MLSChatPageState createState() => _MLSChatPageState();
}

class _MLSChatPageState extends State<MLSChatPage> {
  late PubNub pubNub;
  late Subscription subscription;
  TextEditingController messageController = TextEditingController();
  List<ChatMessage> messages = [];
  String channelName = "MLS";

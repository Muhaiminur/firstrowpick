...
class EplChatPage extends StatefulWidget {
  const EplChatPage({
    super.key,
  });

  @override
  _EplChatPageState createState() => _EplChatPageState();
}

class _EplChatPageState extends State<EplChatPage> {
  final ThemeController themeController = Get.find<ThemeController>();
  late PubNub pubNub;
  late Subscription subscription;
  TextEditingController messageController = TextEditingController();
  List<ChatMessage> messages = [];
  String channelName = "EPL";

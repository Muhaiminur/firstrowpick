...
class NBAChatPage extends StatefulWidget {
  const NBAChatPage({
    super.key,
  });

  @override
  _NBAChatPageState createState() => _NBAChatPageState();
}

class _NBAChatPageState extends State<NBAChatPage> {
  late PubNub pubNub;
  late Subscription subscription;
  TextEditingController messageController = TextEditingController();
  List<ChatMessage> messages = [];
  String channelName = "NBA";

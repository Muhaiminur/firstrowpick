...
class LaligaChatPage extends StatefulWidget {
  const LaligaChatPage({
    super.key,
  });

  @override
  _LaligaChatPageState createState() => _LaligaChatPageState();
}

class _LaligaChatPageState extends State<LaligaChatPage> {
  final ThemeController themeController = Get.find<ThemeController>();
  late PubNub pubNub;
  late Subscription subscription;
  TextEditingController messageController = TextEditingController();
  List<ChatMessage> messages = [];
  String channelName = "LALIGA";

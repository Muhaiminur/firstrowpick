...
class MlbScoreItem extends StatefulWidget {
  final MlbGameData item;
  const MlbScoreItem({super.key, required this.item});

  @override
  State<MlbScoreItem> createState() => _MlbScoreItemState();
}

class _MlbScoreItemState extends State<MlbScoreItem> {

...
class NcaafScoreItem extends StatefulWidget {
  final NcaafGamesData item;
  const NcaafScoreItem({super.key, required this.item});

  @override
  State<NcaafScoreItem> createState() => _NcaafScoreItemState();
}

class _NcaafScoreItemState extends State<NcaafScoreItem> {
